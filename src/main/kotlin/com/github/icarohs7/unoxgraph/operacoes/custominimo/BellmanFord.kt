...
fun Grafo.custoMinimoBellmanFord(origem: Int): ResultadoPonderado {
	return bellmanFord(origem, this as? Grafo.Ponderado ?: throw TipoDeGrafoIncorretoException())
}

private fun bellmanFord(origem: Int, grafo: Grafo.Ponderado): ResultadoPonderado {
